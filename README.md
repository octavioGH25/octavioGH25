...
| :--- | :--- | :--- | :---: |
| **1. [Auditoría Patrimonial y Riesgo Financiero](https://github.com/octavioGH25/Auditoria_Activos_Financieros)** | 🛡️ **Auditoría / Finanzas** <br> *Control Interno* | • Auditoría masiva de **50,000 activos**.<br>• Validación de **$1,615 MDP** en activos vigentes.<br>• Detección de **$671 MDP** en riesgo de obsolescencia. | ![Python](https://img.shields.io/badge/-Python-3776AB?logo=python&logoColor=white) <br> ![Pandas](https://img.shields.io/badge/-Pandas-150458?logo=pandas&logoColor=white) |
